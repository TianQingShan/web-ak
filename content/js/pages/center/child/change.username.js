var _vue = new Vue({
    ...
    methods: {
        'checkData': function () {
            ...
            } else if (this.form.MemberNo === this.currentUser.MemberNo) {
        ...
        'doSubmitAjax': function () {
            ...
            APP.GLOBAL.ajax({
                url: APP.CONFIG.BASE_URL+'Change_UserName',
                data: this.form,
        ...
        'changeLanguage': function () {
            LSE.install('change.username', function (lang) {
